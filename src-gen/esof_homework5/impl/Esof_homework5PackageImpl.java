...
import esof_homework5.Esof_homework5Factory;
import esof_homework5.Esof_homework5Package;
import esof_homework5.Movie;
import esof_homework5.PriceCode;
import esof_homework5.Rental;
...
public class Esof_homework5PackageImpl extends EPackageImpl implements Esof_homework5Package {
	 ...
	 * @see esof_homework5.Esof_homework5Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEOperation(getRental__GetCharge(), null, "getCharge", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getCharge_ChargeValue(), ecorePackage.getEInt(), "chargeValue", null, 0, 1, Charge.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
