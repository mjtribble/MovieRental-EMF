 ...
 * </p>
 * <ul>
 *   <li>{@link edu.montana.esof422.assignment5.esof_homework5.impl.ChargeImpl#getChargeValue <em>Charge Value</em>}</li>
 *   <li>{@link edu.montana.esof422.assignment5.esof_homework5.impl.ChargeImpl#getChargeT <em>Charge T</em>}</li>
 *   <li>{@link edu.montana.esof422.assignment5.esof_homework5.impl.ChargeImpl#getCust <em>Cust</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChargeImpl extends MinimalEObjectImpl.Container implements Charge {
	 ...
	 * @ordered
	 */
	protected static final double CHARGE_VALUE_EDEFAULT = 0.0;
	 ...
	 * @ordered
	 */
	protected double chargeValue = CHARGE_VALUE_EDEFAULT;
	 ...
	 * @generated
	 */
	public void setChargeValue(double newChargeValue) {
		double oldChargeValue = chargeValue;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case Esof_homework5Package.CHARGE__CHARGE_VALUE:
			setChargeValue((Double) newValue);
			return;
		case Esof_homework5Package.CHARGE__CHARGE_T:
